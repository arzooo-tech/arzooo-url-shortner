...
# Arzooo Url Shortener

Forked version of **Kutt**, a modern URL shortener with support for custom domains. Shorten URLs, manage your links and view the click rate statistics.
